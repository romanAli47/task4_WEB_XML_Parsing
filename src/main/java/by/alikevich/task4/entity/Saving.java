...
public class Saving extends BankDeposite {
    ...
    public Saving(String country, int accountId, String bankName) {

        this.bankName = bankName;
        this.accountId = accountId;
        this.country = country;
    }
    public Saving(String depositor, int amount, int profitability, int timeConstraints, String country, int accountId, String bankName) {
...
/*
    ...
    public boolean equals(Object o) {
        ...
        if (accountId != saving.accountId) return false;
        if (!country.equals(saving.country)) return false;
        return bankName.equals(saving.bankName);
    }
