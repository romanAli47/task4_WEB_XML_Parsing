...
public class Metal extends BankDeposite {
    ...
    public Metal(String country, int accountId, String bankName) {

        this.bankName = bankName;
        this.accountId = accountId;
        this.country = country;
    }
    public Metal(String depositor, int amount, int profitability, int timeConstraints, String country, int accountId, String bankName) {
...
*/
    ...
    public boolean equals(Object o) {
        ...
        if (accountId != metal.accountId) return false;
        if (!country.equals(metal.country)) return false;
        return bankName.equals(metal.bankName);
    }
